      ...
      if (MPI_COMPILE_CMDLINE OR MPI_LINK_CMDLINE)
        ...
        if (NOT MPI_INCLUDE_PATH_WORK)
          ...
          find_path(MPI_HEADER_PATH mpi.h
            HINTS ${_MPI_BASE_DIR} ${_MPI_PREFIX_PATH} ${MPI_INCLUDE_DIR} $ENV{MPI_HOME}
        ...
        set(MPI_LINK_PATH ${MPI_LINK_DIR} $ENV{MPI_HOME}/lib)
        ...
        foreach(LIB ${MPI_LIBNAMES})
          ...
          find_library(MPI_LIB NAMES ${LIB} HINTS ${MPI_LINK_PATH} PATH_SUFFIXES lib)
